...
function Vowel() {}
Vowel = new Alpha(), //Write in blank to inherit from Alpha
console.log(Vowel instanceof Alpha),
Vowel.prototype.isVowel = function (letter) {
  return /^[aeiuoyAEIOUY]$/.test(letter);
};

function Consonant() {}
Consonant = new Alpha(), //Write in blank to inherit from Alpha
console.log(Consonant instanceof Alpha),
